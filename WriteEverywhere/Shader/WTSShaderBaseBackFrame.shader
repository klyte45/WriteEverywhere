Shader "Custom/WriteEverything/Frame/Back" {
    Properties
    {
    ...
    SubShader
    {
        ...
        {
            commonVert(v);
            Unity_RotateAboutAxis_Degrees_float(v.normal, float3 (0,1,0), 180,  v.normal.xyz);
            Unity_RotateAboutAxis_Degrees_float(v.tangent, float3 (0,1,0), 180,  v.tangent.xyz);
