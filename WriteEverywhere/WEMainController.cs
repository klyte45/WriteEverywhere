...
namespace WriteEverywhere
{
    public class WEMainController : BaseController<ModInstance, WEMainController>
    {
        ...
        public const string EXTRA_SPRITES_FILES_FOLDER_ASSETS = "K45WE_Sprites";
        ...
        protected override void StartActions()
        {
            ...
            if (SceneUtils.IsAssetEditor)
            {
                ...
                BuildingPropsSingleton.LoadAllBuildingConfigurations(false);
                VehicleTextsSingleton.LoadAllVehiclesConfigurations(false);
            }
            else
            {
