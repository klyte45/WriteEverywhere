...
//        internal void SetParams(VehicleInfo currentInfo, int tabToPreview, string skinName, LayoutDescriptorVehicleXml editingInstancePreview)
//        {
//            CurrentInfo = currentInfo;
//            TabToPreview = tabToPreview;
//            EditingInstancePreview = editingInstancePreview;
//            m_skin = skinName;
//            ResetCamera();
//        }
...
//        public VehicleInfo CurrentInfo { get; set; }
//        public int TabToPreview { get; set; }
//        public LayoutDescriptorVehicleXml EditingInstancePreview { get; set; }
...
//                        if (CurrentTextDescriptor.MaxWidthMeters > 0)
//                        {
//                            textExt.x = Mathf.Min(textExt.x * CurrentTextDescriptor.TextLineHeight, CurrentTextDescriptor.MaxWidthMeters / WTSDynamicTextRenderingRules.SCALING_FACTOR) / CurrentTextDescriptor.TextLineHeight;
//                        }
...
//                    multiplierMax = 2;
//                }
//                TargetZoom = Mathf.Max(Mathf.Min(TargetZoom + eventParam.wheelDelta * 0.125f, m_maxZoom * multiplierMax), 1f / CurrentInfo.m_mesh.bounds.extents.magnitude / CurrentInfo.m_mesh.bounds.extents.magnitude / multiplierMax * Mathf.Min(1, CurrentTextDescriptor?.TextLineHeight ?? 1));
//            }
//        }
...
//            m_previewRenderer.RenderPrefab(CurrentInfo, m_cameraPosition, new Vector3(0, CameraRotation), EditingInstancePreview?.TextDescriptors, CurrentTextDescriptor != null ? TabToPreview : -1, m_overrideText, ref VehicleManager.instance.m_drawCallData.m_batchedCalls, skin: m_skin);
