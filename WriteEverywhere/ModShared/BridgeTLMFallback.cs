    ...
    internal class BridgeTLMFallback : IBridge
    {
        public override LineLogoParameter GetLineLogoParameters(WTSLine lineObj)
        {
            if (!lineObj.regional)
            {
                ...
                CommonsSpriteNames lineIcon;
                switch (TransportManager.instance.m_lines.m_buffer[lineObj.lineId].Info.m_transportType)
                {
                    case TransportInfo.TransportType.Bus:
                        lineIcon = CommonsSpriteNames.K45_HexagonIcon;
                        break;
                    case TransportInfo.TransportType.Trolleybus:
                        lineIcon = CommonsSpriteNames.K45_OvalIcon;
                        break;
                    case TransportInfo.TransportType.Helicopter:
                        lineIcon = CommonsSpriteNames.K45_S05StarIcon;
                        break;
                    case TransportInfo.TransportType.Metro:
                        lineIcon = CommonsSpriteNames.K45_SquareIcon;
                        break;
                    case TransportInfo.TransportType.Train:
                        lineIcon = CommonsSpriteNames.K45_CircleIcon;
                        break;
                    case TransportInfo.TransportType.Ship:
                        if (TransportManager.instance.m_lines.m_buffer[lineObj.lineId].Info.m_vehicleType == VehicleInfo.VehicleType.Ferry)
                        {
                            lineIcon = CommonsSpriteNames.K45_S08StarIcon;
                        }
                        else
                        {
                            lineIcon = CommonsSpriteNames.K45_DiamondIcon;
                        }
                        break;
                    case TransportInfo.TransportType.Airplane:
                        if (TransportManager.instance.m_lines.m_buffer[lineObj.lineId].Info.m_vehicleType == VehicleInfo.VehicleType.Blimp)
                        {
                            lineIcon = CommonsSpriteNames.K45_ParachuteIcon;
                        }
                        else
                        {
                            lineIcon = CommonsSpriteNames.K45_PentagonIcon;
                        }
                        break;
                    case TransportInfo.TransportType.Tram:
                        lineIcon = CommonsSpriteNames.K45_TrapezeIcon;
                        break;
                    case TransportInfo.TransportType.EvacuationBus:
                        lineIcon = CommonsSpriteNames.K45_CrossIcon;
                        break;
                    case TransportInfo.TransportType.Monorail:
                        lineIcon = CommonsSpriteNames.K45_RoundedSquareIcon;
                        break;
                    case TransportInfo.TransportType.Pedestrian:
                        lineIcon = CommonsSpriteNames.K45_MountainIcon;
                        break;
                    case TransportInfo.TransportType.TouristBus:
                        lineIcon = CommonsSpriteNames.K45_CameraIcon;
                        break;
                    default:
                        lineIcon = CommonsSpriteNames.K45_S05StarIcon;
                        break;
                ...
                return new LineLogoParameter { fileName = KResourceLoader.GetCommonsTexturePath(lineIcon), color = lineColor, text = TransportManager.instance.m_lines.m_buffer[lineObj.lineId].m_lineNumber.ToString() };
            }
            else
            {
                ref NetNode node = ref NetManager.instance.m_nodes.m_buffer[lineObj.lineId];
                return new LineLogoParameter { fileName = KResourceLoader.GetCommonsTexturePath(CommonsSpriteNames.K45_S10StarIcon), color = Color.gray, text = lineObj.lineId.ToString("00\n000") };
            }
        }
        ...
        public override void MapLineDestinations(WTSLine lineObj, StopInformation[] cache)
        {
