...
//                        float rowHeight = resultArray.Max(x => x?.m_sizeMetersUnscaled.y ?? 0) * SCALING_FACTOR * textDescriptor.TextLineHeight + textDescriptor.MultiItemSettings.SubItemSpacing.Y;
//                        float columnWidth = (unscaledColumnWidth * textDescriptor.TextLineHeight) + textDescriptor.MultiItemSettings.SubItemSpacing.X;
//                        var maxWidth = textDescriptor.MaxWidthMeters;
...
//                {
//                    BasicRenderInformation bgBri = ModInstance.Controller.AtlasesLibrary.GetFromLocalAtlases(null, KlyteResourceLoader.GetDefaultSpriteNameFor(LineIconSpriteNames.K45_SquareIcon));
//                    if (bgBri != null)
//                    {
...
//            var lineAdjustmentVector = new Vector3(0, (-textDescriptor.BackgroundMeshSettings.Size.Y / 2) + (32 * SCALING_FACTOR * textDescriptor.TextLineHeight) - (bgBri.m_YAxisOverflows.min + bgBri.m_YAxisOverflows.max) * SCALING_FACTOR * textDescriptor.TextLineHeight / 2, -0.001f);
