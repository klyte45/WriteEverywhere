...
//            {
//                case TextContent.None:
//                    return LegacyOnNet(textDescriptor, segmentId, boardIdx, secIdx, propDescriptor, ref baseFont, ref multipleOutput);
//                case TextContent.ParameterizedText:
//                case TextContent.ParameterizedSpriteFolder:
//                case TextContent.ParameterizedSpriteSingle:
...
//        private static BasicRenderInformation LegacyInfoPreview(BoardTextDescriptorGeneralXml textDescriptor, ref IEnumerable<BasicRenderInformation> multipleOutput, DynamicSpriteFont baseFont, BoardPreviewInstanceXml preview, string otherText)
//        {
//            switch (textDescriptor.OLD__TextType)
//            {
...
//                    return TextParameterWrapper.GetRenderInfo(preview, textDescriptor, 0, 0, 0, out multipleOutput);
//                default:
//                    string text = $"{textDescriptor.OLD__TextType}: {preview.m_currentText}";
...
//        private static BasicRenderInformation LegacyOnNet(BoardTextDescriptorGeneralXml textDescriptor, ushort segmentId, int boardIdx, int secIdx, OnNetInstanceCacheContainerXml propDescriptor, ref DynamicSpriteFont baseFont, ref IEnumerable<BasicRenderInformation> multipleOutput)
//        {
...
//                    if (segmentData.DistrictId == 0 && segmentData.ParkId > 0 && textDescriptor.OLD__TextType == TextType.ParkOrDistrict)
//                    {
...
//                case TextType.ParameterizedGameSpriteIndexed:
//                    return TextParameterWrapper.GetRenderInfo(propDescriptor, textDescriptor, segmentId, boardIdx, secIdx, out multipleOutput);
//                case TextType.HwShield: return ModInstance.Controller.HighwayShieldsAtlasLibrary.DrawHwShield(NetManager.instance.m_segments.m_buffer[targetSegment].m_nameSeed);
//                default: return null;
//            };
//        }

//        private static BasicRenderInformation LegacyVehicle(BoardTextDescriptorGeneralXml textDescriptor, ushort refID, DynamicSpriteFont baseFont, LayoutDescriptorVehicleXml vehicleDescriptor)
//        {
//            var targetType = textDescriptor.OLD__TextType;
//            switch (targetType)
//            {
...
//                    return ModInstance.Controller.AtlasesLibrary.DrawLineFormats(new WTSLine[] { ModInstance.Controller.ConnectorTLM.GetVehicleLine(refID) }).FirstOrDefault();
//                case TextType.LineFullName:
//                    var regLine = ModInstance.Controller.ConnectorTLM.GetVehicleLine(refID);
...
//                    var regLine2 = ModInstance.Controller.ConnectorTLM.GetVehicleLine(refID);
//                    return WTSCacheSingleton.GetTextData(ModInstance.Controller.ConnectorTLM.GetStopName(targetVehicle7.m_targetBuilding, regLine2), textDescriptor.m_prefix, textDescriptor.m_suffix, baseFont, textDescriptor.m_overrideFont);
...
//                    var regLine3 = ModInstance.Controller.ConnectorTLM.GetVehicleLine(refID);
//                    return WTSCacheSingleton.GetTextData(ModInstance.Controller.ConnectorTLM.GetStopName(TransportLine.GetPrevStop(targetVehicle5.m_targetBuilding), regLine3), textDescriptor.m_prefix, textDescriptor.m_suffix, baseFont, textDescriptor.m_overrideFont);
...
//                    var regLine4 = ModInstance.Controller.ConnectorTLM.GetVehicleLine(refID);
...
//                            : stopInfo.m_destinationId != 0 ? WTSCacheSingleton.GetTextData(ModInstance.Controller.ConnectorTLM.GetStopName(stopInfo.m_destinationId, regLine4), textDescriptor.m_prefix, textDescriptor.m_suffix, baseFont, textDescriptor.m_overrideFont)
//                            : WTSCacheSingleton.GetTextData(ModInstance.Controller.ConnectorTLM.GetStopName(targetVehicle.m_targetBuilding, regLine4), textDescriptor.m_prefix, textDescriptor.m_suffix, baseFont, textDescriptor.m_overrideFont);
//                        return result;
//                    }
